                                    ...
                                    <form onsubmit="AdminLogin(event)">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="username" id="username"
                                                class="form-control shadow-none" autofocus placeholder="Username"
                                                autocomplete="off" />
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <div style="position: relative;" class="password">
                                                <input type="password" name="password" id="password"
                                                    ...
                                                    autocomplete="off" />
                                                <i class="fa fa-eye"
                                                    style="position: absolute;top: 13px;right: 10px;cursor:pointer;"
                                                    onclick="passwordShow(event)"></i>
                                            </div>
                                            <p class="error-password m-0" style="font-style: italic;"></p>
                                        </div>
                                        <button type="submit" name="login" id="login"
                                            class="btn btn-block login-btn mb-4 shadow-none">Login</button>
                                    </form>
                                </div>
                            </div>
                        </div>
