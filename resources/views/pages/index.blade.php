                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input type="email" class="form-control" placeholder="Email Address"
                                        v-model="booking.email" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="Phone Number"
                                        v-model="booking.phone" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input type="date" class="form-control" placeholder="Select Date"
                                        v-model="booking.booking_date" :min="minDate" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input type="time" class="form-control" placeholder="Select Time"
                                        v-model="booking.booking_time" min="12:00" max="22:00" required>
                                </div>
                            </div>

                            <div class="form-group">
                                <div class="input-group">
                                    <input type="number" min="1" class="form-control" placeholder="Select People"
                                        v-model="booking.persons" required>
                                </div>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="my-4 my-md-0" data-aos="fade-up" data-aos-delay="150">
                            <img class="img-fluid" style="width:100%" src="{{ asset($lunch->optionA_image) }}">
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 p-0 d-none d-md-block" style="overflow: hidden">
                <video class="booking-vid" controls autoplay muted loop controlsList="nodownload">
                    <source src="{{ asset(isset($CocktailDesp) ? $CocktailDesp->cocktail_video : '') }}"
                        type="video/mp4">
                </video>
            </div>
        </div>
                    ...
                    @forelse ($Blog as $blog)
                        <div class="col-md-4">
                            <div class="blogCard" data-aos="fade-up" data-aos-delay="100">
                                <img class="img-fluid blog-img" src="{{ asset($blog->image) }}" alt="">
                                <div class="p-3 cardinfo">
                                    <small>Wed, {{ $blog->date }}</small>
                                    <h5 class="blogcard-title">{{ $blog->title }}</h5>
                                    <a href="{{ route('blog_details', $blog->slug) }}" type="button"
                                        class="poi-link">Read
                                        more</a>
                                </div>
                            </div>
...
@push('script')
    ...
    <script>
        new Vue({
            ...
            methods: {
                saveBooking() {
                    if (this.booking.name == '' || this.booking.phone == '' || this.booking.date == '' || this
                        .booking.booking_date == '' || this.booking.booking_time == '' || this.booking.persons == ''
                        ) {
                        Toast.fire({
                            icon: 'error',
