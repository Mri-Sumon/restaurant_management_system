    ...
    <div class="navbar-container ace-save-state" id="navbar-container">
        ...
        <div class="navbar-header pull-left">
            <a href="/module/dashboard" class="navbar-brand" style="padding-left: 0;">
                <small>
                    <img style="width: 25px;border: 1px solid gray;"
                        src="{{ asset($company->logo ? $company->logo : '/noImage.gif') }}" alt="">
            ...
            <ul class="nav ace-nav">
                <li class="clock_li">
                    <a class="clock" style="background:#3e2e6b !important;">
                        <span style="font-size:20px;"><i class="ace-icon fa fa-clock-o"></i> </span>
