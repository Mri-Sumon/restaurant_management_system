...
<ul class="nav nav-list">
    ...
    <li
        class="{{ Request::is('table') || Request::is('tablelist') || Request::is('chair') ? 'open' : '' }}">
...
@if (checkAccess('management') || checkAccess('gallery'))
<ul class="nav nav-list">
    <li class="active">
        <a href="/module/dashboard">
            <i class="menu-icon fa fa-tachometer"></i>
    ...
    <li class="{{ Request::is('create') ? 'active' : '' }}">
        <a href="{{ route('cocktails.create') }}">
            ...
            <span class="menu-text"> Cocktails Entry </span>
        </a>
        <b class="arrow"></b>
    </li> -->

    <li
        class="{{ Request::is('concktailsEntry') || Request::is('cocktails-description')  ? 'open' : '' }}">
        <a href="/" class="dropdown-toggle">
            <i class="menu-icon fa fa-glass"></i>
...
<ul class="nav nav-list">
    ...
    checkAccess('reorderList'))
    <li
        class="{{ Request::is('assetlist') || Request::is('reorder-list') || Request::is('supplier-ledger') || Request::is('supplier-due') || Request::is('supplierlist') || Request::is('purchase-invoice') ? 'open' : '' }}">
        <a href="/" class="dropdown-toggle">
...
<ul class="nav nav-list">
    ...
    checkAccess('loanView'))
    <li
        class="{{ Request::is('loan-transaction') || Request::is('loan-account') || Request::is('loan-view') || Request::is('loan-transaction-report') || Request::is('loan-ledger') ? 'open' : '' }}">
        <a href="/" class="dropdown-toggle">
            <i class="menu-icon fa fa-file"></i>
    ...
    checkAccess('investmentTransactionReport'))
    <li
        class="{{ Request::is('investment-account') || Request::is('investment-transaction') || Request::is('investment-ledger') || Request::is('investment-transaction-report') || Request::is('investment-view') ? 'open' : '' }}">
        <a href="/" class="dropdown-toggle">
            <i class="menu-icon fa fa-file"></i>
    ...
    checkAccess('cashLedger'))
    <li
        class="{{ Request::is('cash-ledger') || Request::is('customer-payment-history') || Request::is('supplier-payment-history') || Request::is('daybook') || Request::is('cash-statement') || Request::is('balance-inout') || Request::is('balance-sheet') || Request::is('bank-ledger') || Request::is('cash-transaction-report') || Request::is('bank-transaction-record') ? 'open' : '' }}">
        <a href="/" class="dropdown-toggle">
            <i class="menu-icon fa fa-file"></i>
...
<ul class="nav nav-list">
    ...
    <li
        class="{{ Request::is('leave-type') || Request::is('leave') || Request::is('leave-record') ? 'open' : '' }}">
        <a href="/" class="dropdown-toggle">
...
<ul class="nav nav-list">
    ...
    checkAccess('bankTransactionReport'))
    <li
        class="{{ Request::is('cash-ledger') || Request::is('daybook') || Request::is('balance-inout') || Request::is('bank-ledger') || Request::is('cash-statement') || Request::is('cash-transaction-report') || Request::is('bank-transaction-record') ? 'open' : '' }}">
        <a href="/" class="dropdown-toggle">
            <i class="menu-icon fa fa-file"></i>
...
checkAccess('payFirst') ||
checkAccess('orderList') ||
checkAccess('menuCategory') ||
checkAccess('unit'))
<ul class="nav nav-list">
    <li class="active">
        <a href="/module/dashboard">
    ...
    <li
        class="{{ Request::is('menu') || Request::is('menuList') || Request::is('menu-category') ? 'open' : '' }}">
        <a href="/" class="dropdown-toggle">
    ...
    checkAccess('productionList') ||
    checkAccess('materialPurchase') ||
    checkAccess('materialPurchaseList') ||
    checkAccess('materialStock'))
    <li
        class="{{ Request::is('material') || Request::is('productionList') || Route::is('material.purchase.create') || Request::is('materialPurchaseList') || Request::is('materialStock') ? 'open' : '' }}">
        <a href="/" class="dropdown-toggle">
    ...
    <li
        ...
        <ul class="submenu">
            ...
            <li class="{{ Route::is('requisition.create') ? 'active' : '' }}">
                <a href="/requisition">
                    <i class="menu-icon fa fa-caret-right"></i>
                    Requisition Entry
                </a>
            ...
            <li class="{{ Request::is('requisitionList') ? 'active' : '' }}">
...
@if (checkAccess('kitchen_pending_order') || checkAccess('kitchen_delivered_order'))
<ul class="nav nav-list">
    <li class="active">
        <a href="/module/dashboard">
            <i class="menu-icon fa fa-tachometer"></i>
    ...
    <li>
        <a href="/module/KitechenModule" class="module_title">
            <span>Kitchen Module</span>
        </a>
    </li>

    @if (checkAccess('kitchen_pending_order'))
    <li class="{{ Route::is('pending.delivery') ? 'active' : '' }}">
    ...
    <li class="{{ Route::is('kitchen_delivered.order') ? 'active' : '' }}">
...
checkAccess('issueReturn') ||
checkAccess('issueRecord') ||
checkAccess('asset') ||
checkAccess('assetList'))
<ul class="nav nav-list">
    <li class="active">
        <a href="/module/dashboard">
            <i class="menu-icon fa fa-tachometer"></i>
    ...
    <li
        class="{{ Request::is('asset') || Request::is('assetList') || Request::is('brand') ? 'open' : '' }}">
        <a href="/" class="dropdown-toggle">
            <i class="menu-icon bi bi-shop"></i>
    ...
    <li
        class="{{ Route::is('purchase.create') || Request::is('purchaseList') || Request::is('supplier') ? 'open' : '' }}">
        <a href="/" class="dropdown-toggle">
