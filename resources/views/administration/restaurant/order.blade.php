            ...
            <div class="tab-content" style="border: none;padding: 0px">
                <div v-if="tableForm" style="padding: 10px">
                    <div class="row" style="border-bottom: 1px solid gray;">
                        <div class="col-md-12 col-xs-12 border-radius"
                            style="display:flex;align-items:center;padding:0 !important;background:#aee2ff;border: 1px groove #848f95 !important;padding:5px 0;">
                            <div class="col-md-4">
                                <div class="date" style="display:flex;align-items:center;gap:5px;">
                                    <label for="" style="width: 25%;">Table Type</label>
                                    <div style="width: 55%;">
                                        <select class="form-control" v-model="filter.typeId"
                                            style="border-radius:5px;margin:0;height:30px;">
                                            <option value="">All</option>
                                            <option v-for="tabletype in tabletypes" :value="tabletype.id">
                                                @{{ tabletype.name }}</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="date" style="display:flex;align-items:center;gap:5px;">
                                    ...
                                    <div style="width: 70%;">
                                        <select class="form-control" v-model="filter.inchargeId"
                                            style="border-radius:5px;margin:0;height:30px;">
                                            <option value="">All</option>
                                            <option v-for="incharge in incharges" :value="incharge.id">
                                                @{{ incharge.name }}</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-1 col-xs-12" style="float:right">
                                <button type="button" @click="getTables"
                                    style="cursor:pointer;font-size:18px;border:1px groove #848f95;padding:0px 10px;border-radius:5px;background:white;">
                                    <i class="bi bi-search"></i>
                                </button>
                            </div>
                        </div>
                    </div>
                    <div class="row" style="margin-top:10px;padding:0;display:none;"
                        v-if="floors.length > 0 && showReport"
                        :style="{ display: floors.length > 0 && showReport ? '' : 'none' }">
                        <div class="col-md-12 col-xs-12" v-for="floor in floors" style="padding:0;"
                            v-if="floor.tables.length > 0">
                            <h3
                                style="border-bottom: 1px double rgb(232, 97, 0); text-align: left; background: #224079; padding: 5px;">
                                @{{ floor.name }}</h3>
                            <form action="">
                                                        ...
                                                        <div class="card-image text-center">
                                                            ...
                                                            <div class="top-right-text">
                                                                <div class="col-xs-6 no-padding" style="text-align: left;">
                                                                    <input :disabled="tableCart.length == 0 ? false : true"
                                                                        @change="addToTableCart($event)" type="checkbox"
                                                                        :value="tableItem.id" :id="'table-' + tableItem.id">
                                                                </div>
                                                                <div class="col-xs-6 no-padding"
                                                                    style="display: flex; justify-content: end;">
                                                                    <button type="button" class="icon-container"
                                                                        @click="showTableInfo(tableItem.id)">
                                ...
                                <div class="control-group">
                                    <div class="row" style="margin:0;">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <select id="customerType" v-model="customerType" class="form-control"
                                                    @change="onChangeType" style="border-radius: 5px; margin: 0;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" id="invoiceNo" class="form-control"
                                                    v-model="order.invoice" readonly />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-1 control-label no-padding">@{{ label != '' ? label : 'Name' }}
                                            </label>
                                            <div class="col-sm-3">
                                                <input type="text"
                                                    v-if=" customerType == 'cash' || customerType == 'new'"
                                                    style="display: none;"
                                                    :style="{ display: customerType == 'cash' || customerType == 'new' ? '' :
                                                            'none' }"
                                                    id="customerName" placeholder="Customer Name" class="form-control"
                                                    v-model="selectedCustomer.name"
                                                    v-bind:disabled="customerType == 'cash' || customerType == 'new' ? false : true" />

                                                <v-select style="display: none;"
                                                    :style="{ display: customerType == 'existing' ? '' : 'none' }"
                                                    :options="customers" v-model="selectedCustomer" id="customer"
                                                    label="display_name"></v-select>
                                            </div>
                                        </div>

                                        <div class="form-group" class="form-group" v-if=" customerType == 'existing'"
                                            style="display: none;"
                                            :style="{ display: customerType == 'existing' ? '' : 'none' }">
                                            <label class="col-sm-1 control-label no-padding"> Name </label>
                                            <div class="col-sm-3">
                                                <input type="text" id="cusName" placeholder="Name"
                                                    class="form-control" v-model="selectedCustomer.name" disabled
                                                    autocomplete="off" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" id="mobileNo" placeholder="Mobile No"
                                                    class="form-control" v-model="selectedCustomer.phone"
                                                    v-bind:disabled="customerType == 'cash' || customerType == 'new' ? false : true"
                                                    autocomplete="off" />
                                            </div>
                                        </div>

                                        <div class="form-group" v-if=" customerType == 'cash' || customerType == 'new'"
                                            style="display: none;"
                                            :style="{ display: customerType == 'cash' || customerType == 'new' ? '' : 'none' }">
                                            <label class="col-sm-1 control-label no-padding">Address </label>
                                            <div class="col-sm-3">
                                                <input type="text" id="Address" placeholder="Address"
                                                    class="form-control" v-model="selectedCustomer.address"
                                                    v-bind:disabled="customerType == 'cash' || customerType == 'new' ? false : true" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <tr v-for="(item, sl) in tableCart">
                                                ...
                                                <td>@{{ item.name }}</td>
                                                <td><!-- @{{ item.chairName }} -->
                                                    <v-select :options="item.chairs" v-model="item.chairName"
                                                        label="name"
                                                        @input="getOrdersByTableChair(item.bench_id, item.chair_id, item.chairName.id)"
                                                        placeholder="Select Chair"></v-select>
                                                </td>
                                                <td>@{{ item.typeName }}</td>
                    ...
                    <div class="row" style="margin:0;">
                        <div class="col-md-2">
                            <fieldset class="scheduler-border bg-of-skyblue" style="height: 300px;"
                                :style="{ overflowY: categories.length > 8 ? 'scroll' : 'auto' }">
                                    ...
                                    <div class="sidebar-nav">
                                        <ul class="nav navbar-nav" style="display: none"
                                            ...
                                            <li v-for="item in categories"
                                                :class="{ active: item.id == selectedCategory }"><a type="button"
                                                    @click="categoryOnChange(item.id)">@{{ item.name }}</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </fieldset>
                        ...
                        <div class="col-md-5">
                            <fieldset class="scheduler-border bg-of-skyblue" style="height: 300px;"
                                :style="{ overflowY: filterMenus.length > 8 ? 'scroll' : 'auto' }">
                                ...
                                <div class="control-group">
                                    <div class="col-md-12" style="padding: 0;">
                                        ...
                                        <div class="menu_div">
                                            <div class="menu-image" v-for="menu in filterMenus"
                                                @click.prevent="chooseMenu(menu)">
                                                <img :src="menu.image ? '/' + menu.image : '/noImage.gif'"
                                                    :alt="menu.name" class="img-responsive">
                                                <p>@{{ menu.name }}</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody style="height: 175px !important">
                                            <tr v-for="(product, sl) in cart">
                                                ...
                                                <td width="20%">
                                                    <input class="form-control" min="0" style="height: 20px"
                                                        type="number" step="0.01" v-model="product.price"
                                                        v-on:input="menuTotal(product)">
                                                </td>
                                                <td width="15%">
                                                    <input class="form-control" min="1" style="height: 20px"
                                                        type="number" v-model="product.quantity"
                                                        v-on:input="menuTotal(product)">
                                                </td>
                                                <td width="20%">@{{ product.total }}</td>
                                                <td width="5%"><a href=""
                                                        v-on:click.prevent="removeFromCart(sl)"><i
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9 no-padding-right">
                                                <input type="number" id="subTotal" class="form-control"
                                                    v-model="order.sub_total" readonly />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right"> VAT</label>
                                            <div class="col-sm-3 no-padding-right">
                                                <input type="number" min="0" id="vatPercent"
                                                    class="form-control" v-model="vatPercent"
                                                    v-on:input="calculateTotal" />
                                            </div>
                                            <label class="col-sm-1 control-label"> %</label>
                                            <div class="col-sm-5 no-padding-right">
                                                <input type="number" id="vat" class="form-control"
                                                    v-model="order.vat" v-on:input="calculateTotal" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right"> Discount</label>
                                            <div class="col-sm-3 no-padding-right">
                                                <input type="number" min="0" id="discountPercent"
                                                    class="form-control" v-model="discountPercent"
                                                    v-on:input="calculateTotal" />
                                            </div>
                                            <label class="col-sm-1 control-label"> %</label>
                                            <div class="col-sm-5 no-padding-right">
                                                <input type="number" id="discount" class="form-control"
                                                    v-model="order.discount" v-on:input="calculateTotal" />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="number" id="total" class="form-control"
                                                    v-model="order.total" readonly />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right"> Cash Paid</label>
                                            <div class="col-sm-9">
                                                <input type="number" step="0.01" min="0" id="cashPaid"
                                                    class="form-control" v-model="order.cashPaid"
                                                    v-on:input="paidCalculate" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12 no-padding-right text-right" style="margin-top: 5px;">
                                                <a class="btn btn-danger btn-reset"
                                                    style="font-size:11px;padding:0px 30px !important"
                                                    @click.prevent="onClickPrevious($event)"><i
                                                        class="bi bi-arrow-left"></i> Previous</a>

                                                <input :disabled="onProgress" type="button" @click="draftOrder"
                                                    class="btn btn-warning btn-padding" value="Draft">

                                                <input :disabled="onProgress" v-if="order.id != 0" type="button"
                                                    @click="saveOrder" class="btn btn-primary btn-padding"
                                                    :value="btnText">
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content" style="border-radius:20px;">
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title" style="text-align:left;font-weight:bold;color:#000;">Table:
                            @{{ tableInfo.name }}</h3>
                    </div>
        ...
        new Vue({
            ...
            methods: {
                ...
                async draftOrder() {
                    ...
                    if (this.order.bankPaid == '') {
                        this.order.bankPaid = 0;
                    }
                ...
                paidCalculate() {
                    ...
                    this.order.paid = (cashPaid + bankPaid).toFixed(2);
                ...
                async addToTableCart(event) {
                    ...
                    if (event.target.checked) {
                        ...
                        let cart = {
                            ...
                            name: table.name,
                            chairs: table.chairs,
                            chair_id: table.chairs[0].id,
                            chairName: table.chairs[0].name,
                ...
                async getOrdersByTableChair(benchId, fChairId, sChairId) {

                    let chairId = sChairId != undefined ? sChairId == undefined ? '' : sChairId : fChairId;
                    ...
                    // Get Table/Chair Wise Order
                    let order = await axios.post('/get-order-by-chair', {
                        benchId: benchId,
                        chairId: chairId
                    }).then(res => {
                        return res.data[0];
                ...
                calculateTotal() {
                    ...
                    if (event.target.id == 'cashPaid' || event.target.id == 'bankPaid') {
                        ...
                        if (this.customerType == 'cash') {
                            ...
                            this.order.paid = parseFloat(this.order.cashPaid).toFixed(2);
                        } else {
                            if (this.order.id != 0) {
                                this.order.paid = parseFloat(this.order.cashPaid).toFixed(2);
                            }else{
                    ...
                    if (this.order.id != 0) {
                        this.order.due = parseFloat(this.order.total) - parseFloat(this.order.cashPaid);
                    }
                ...
                getOrder() {
                    ...
                    axios.post("/get-order", {
                        ...
                        this.selectedCustomer = {
                            ...
                            name: customerId == null ? order.customer_name : order.customer ? order
                                .customer.name : 'n/a',
                            phone: customerId == null ? order.customer_phone : order.customer ? order
                                .customer.phone : 'n/a',
                            address: customerId == null ? order.customer_address : order.customer ?
                                order.customer.address : 'n/a',
                            display_name: customerId == null ? "Cash Customer" :
                                `${order.customer ? order.customer.code : 'n/a'} - ${order.customer ? order.customer.name : 'n/a'}`,
                        ...
                        // let tdetail = {
                        //     bench_id: order.bench_id,
                        //     name: order.table.name,
                        //     chairs: order.chairs,
                        //     chair_id: order.chair_id,
                        //     chairName: order.chair_name,
