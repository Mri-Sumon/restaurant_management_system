                    ...
                    <div class="col-md-3">
                        <div class="group">
                            ...
                            <ul class="orders">
                                ...
                                <li><input type="checkbox" name='access[]' @click="singleCheck" class="orders" value="requisition" id="requisition"><label for="requisition"> Requisition Entry</label></li>
                                <li><input type="checkbox" name='access[]' @click="singleCheck" class="orders" value="requisitionList" id="requisitionList"><label for="requisitionList"> Requisition List</label></li>
                        ...
                        {{-- kitchen --}}
                        <div class="group">
                            <input type="checkbox" id="kitchens" class="group-head" @click="onClickGroupHeads"> <label for="kitchens"><strong>Kitchen</strong></label>
                            <ul class="kitchens">
                                <li><input type="checkbox" name='access[]' @click="singleCheck" class="kitchen_pending_order" value="kitchen_pending_order" id="kitchen_pending_order"><label for="kitchen_pending_order"> Pending Orders</label></li>
                                <li><input type="checkbox" name='access[]' @click="singleCheck" class="kitchen_delivered_order" value="kitchen_delivered_order" id="kitchen_delivered_order"><label for="kitchen_delivered_order"> Delivered Orders</label></li>
                            </ul>
                        </div>
                        {{-- kitchen --}}
