...
<div class="row" id="dashboard">
    <div class="col-md-12 col-xs-12">
        ...
        <div class="col-md-12 header headerForDash" style="height: 130px;">
            <img style="height: 100px;margin-top:10px;width: 465px;border-radius: 15px;border: 2px solid #3e2e6b !important;"
                src="{{ asset('auth/images/logo.png') }}" class="img img-responsive center-block">
        </div>
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="col-md-3 col-xs-6 section4">
                <div class="col-md-12 section122" style="background-color:#d8ebeb;"
                    onmouseover="this.style.background = '#bddddd'"
                    onmouseout="this.style.background = '#d8ebeb'">
                    <a href="/graph">
                        <div class="logo">
                ...
                <div class="col-md-12 section20">
                    <a href="/messages">
                        ...
                        <div class="textModule">
                            ...
                            @endphp
                            Messages @if ($cnt > 0)<span class="badge notify">{{$cnt}}</span>@endif
                        </div>
                    </a>
                </div>
            </div>
