                                        ...
                                        <tbody>
                                            <template v-for="(item, sl) in carts">
                                                <tr>
                                                    ...
                                                    <td class="">
                                                        <button type="button" class="icon-container" @click="showTableInfo(item.bench_id)">
                                                            <i class="bi bi-info"></i>
                                                        </button>
        ...
        methods: {
            ...
            async addToCart(event) {
                if (event.target.checked) {
                    ...
                    let findIndex = this.carts.findIndex(item => item.bench_id == event.target.value);
            ...
            otherAddToCart() {
                ...
                let member = {
                    bench_id: this.selectedCart.bench_id,
