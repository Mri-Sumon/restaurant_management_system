    ...
    new Vue({
        ...
        methods: {
            ...
            saveTable(event) {
                ...
                formdata.append('bench_type_id', this.selectedTableType != null ? this.selectedTableType.id : '');
            ...
            editData(row) {
                ...
                if (row.bench_type_id != null) {
                    this.selectedTableType = {
                        id: row.bench_type_id,
