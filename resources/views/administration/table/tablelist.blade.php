                    ...
                    <table class="table table-bordered table-condensed">
                        ...
                        <tbody>
                            <tr v-for="(item, sl) in tables">
                                ...
                                <td style="text-align: center !important;">@{{ item.code }}</td>
                                <td style="text-align: left !important;">@{{ item.name }}</td>
                                <td style="text-align: center !important;">@{{ item.tabletype_name }}</td>
                                <td>@{{ item.floor_name }}</td>
                                <td>@{{ item.incharge_name }}</td>
                                <td style="text-align: center !important;">@{{ item.capacity }}</td>
                                <td style="text-align: center !important;">@{{ item.location }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
