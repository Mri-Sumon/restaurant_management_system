            ...
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3 col-xs-8">
                        <v-select :options="employees" v-model="selectedEmployee" label="display_name" placeholder="Select Employee"></v-select>
                    </div>
                </div>
                    ...
                    <div class="control-group">
                        <form @submit.prevent="addToCart">
                            <div class="form-group">
                                ...
                                <div class="col-xs-8" style="display: flex;align-items:center;margin-bottom:4px;">
                                    <div style="width: 89%;">
                                        <v-select v-bind:options="assets" style="margin: 0;" id="asset" v-model="selectedAsset" label="display_name" placeholder="Select Asset" @input="onChangeAsset" @search="onSearchAsset"></v-select>
                                    </div>
                                    <div style="width: 11%;margin-left:2px;">
