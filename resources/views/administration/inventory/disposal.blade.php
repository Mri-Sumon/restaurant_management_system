                ...
                <fieldset class="scheduler-border bg-of-skyblue">
                    ...
                    <div class="control-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-8">
                                <button type="button" @click="addToCart" class="add-cart-btn pull-right">Add to Cart</button>
                            </div>
                        </div>
                    </div>
                </fieldset>
...
<script>
    new Vue({
        ...
        methods: {
            ...
            async saveDisposal() {
                this.disposal.bench_id = this.selectedTable != null ? this.selectedTable.id : "";
                if (this.disposal.id == 0) {
